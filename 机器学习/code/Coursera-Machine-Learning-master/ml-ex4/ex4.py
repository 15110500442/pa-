...
print('t1:',Theta1.shape)
print('t2:',Theta2.shape)
# Unroll parameters 
...
'''
对于神经网络，首先应该先实现
feedforward神经网络的一部分，只返回成本。 您
应该完成nnCostFunction.m中的代码以返回成本。 后
实现前馈来计算成本，您可以验证
通过验证您获得相同的费用，您的实施是正确的
作为我们的固定调试参数。
我们建议在没有*正规化的情况下实施前馈成本*
first以便您更容易调试。 后来，在第4部分，你
将实现规范化成本。
'''
#
